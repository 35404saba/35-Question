...
function removeFalseyValues(array1) {
...
const filterarray1 = removeFalseyValues(array1);
console.log(filterarray1);
//Q=17
//Write a script that concatenates two arrays [1, 2, 3] and [4, 5, 6] into a single array.
let array2 = [1, 2, 3];
let array3 = [4, 5, 6];
let concatenatedArray = array2.concat(array3);
...
let array6 = [4, 5, 3, 7, 8, 9, 1];
function SmallestNumber(array6) {
    if (array6.length === 0) {
        return null;
    }
