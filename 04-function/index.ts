...
let array4: number[] = [1, 2, 3, 2, 5, 6, 2, 3, 3, 5, 6, 6, 7, 8];

function countOccurrences(array4: number[], element: number) {
  let count: number = 0;
...
let name2: string[] = ["saba", "iqra", "misbah", "rubaha", "maria"];
let name3: string[] = ["saba", "mushtaq"];
let name4: string[] = ["saba"];
let name5: string[] = [];
